          ...
          <div className="w-1/6 bg-blue-900 text-center text-white">
            ...
            <Link href="/Threedots">
              <span className="flex font-bold text-xl py-6 pl-8 transition duration-200 hover:bg-white hover:text-blue-500">
                ...
                <p className="px-6">設定</p>
              </span>
            </Link>
            <div className="fixed bottom-0 left-0 p-10 m-8 rounded-2xl bg-white text-sm">
              <p className="py-5 text-blue-500 text-center  text-xl font-bold">
                Manager
              </p>
              <p className="py-5 text-blue-500 text-center  text-xl font-bold">
                Username
